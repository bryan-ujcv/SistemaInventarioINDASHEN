...
$resin=mysqli_query($con,$ins);
    ...
    $ins="INSERT INTO `condiciones`(`id`, `contenedor_id`, `tipo_condicion`, `observacion`, `llanta1`, `llanta2`, `llanta3`, `llanta4`, `llanta5`, `llanta6`, `llanta7`, `llanta8`) VALUES (null,'$cont','Entrada','$obs','$llanta1','$llanta2','$llanta3','$llanta4','$llanta5','$llanta6','$llanta7','$llanta8')";
$resin=mysqli_query($con,$ins);
...
if($resin){
    echo "<script> 
    location.href='../ModuloContenedores/inventarioMes.php'        
    </script>";
}else{
