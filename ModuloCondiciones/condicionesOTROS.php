        ...
        <table id="mytable" class="table table-fixed table-bordered border-primary table-hover table-sm table-condensed">
            <thead>
                <tr>
                    ...
                    <th class="bg-light" scope="col">Cliente</th>
            ...
            <tbody>
                ...
                ?>
                                    <tr>
                                        ...
                                        <td scope="row"><?php echo $fila['cliente'] ?></td>
