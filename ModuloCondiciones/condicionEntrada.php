...
$LC = "SELECT id FROM contenedores ORDER BY id DESC LIMIT 1";
    ...
    <form action="input.php" method="post">
        <div class="row">
            <div class="col-md-3">
                ...
                <input type="text" class="form-control" id="num" name="num_contenedor" placeholder="Numero del Contenedor" value="<?php echo $num ?>"><br>
            </div>
            <div class="form-group col-md-3">
                <h5>Chasis</h5>
                <input type="text" class="form-control" id="chasis" name="chasis" value="<?php echo $cha ?>" placeholder="Chasis"><br>
            </div>
            <div class="form-group col-md-2">
                <h5>Placa Chasis</h5>
                <input value="<?php echo $placha ?>" type="text" class="form-control" id="placa" name="placa_chasis" placeholder="Placa Chasis"><br>
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-3">
                <h5>Piloto de Ingreso</h5>
                <input type="text" value="<?php echo $piloto ?>" class="form-control" id="piloto" name="piloto_ingreso" placeholder="Piloto de Ingreso"><br>
            </div>
            <div class="form-group col-md-3">
                <h5>Placa del Piloto de Ingreso</h5>
                <input type="text" class="form-control" value="<?php echo $plapi ?>" id="placapiloto" name="placa_piloto_ingreso" placeholder="Placa del Piloto de Ingreso"><br>
            </div>
            <div class="col-md-3">
                <h5>Empresa de Ingreso</h5>
                <input type="text" class="form-control" id="empresa" value="<?php echo $empresa ?>" name="empresa" placeholder="Empresa de Ingreso"><br>
            </div>
        </div>
        <h5>Llantas</h5><br>
        <div class="row">
