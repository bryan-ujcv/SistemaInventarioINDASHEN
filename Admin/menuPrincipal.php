    ...
    <nav class="navbar sticky-top navbar-light justify-content-between" style="background-color: #e3f2fd;">
        <ul class="nav justify-content-end">
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Contenedores</a>
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="ModuloContenedores/Maersk/inventarioMes.php">Inventario MAERSK</a>
                    <a class="dropdown-item" href="ModuloContenedores/Maersk/historialCompleto.php">Historial MAERSK</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="ModuloContenedores/Otros/inventarioMes.php">Inventario Otros</a>
                    <a class="dropdown-item" href="ModuloContenedores/Otros/historialCompleto.php">Historial Otros</a>
                    <div class="dropdown-divider"></div>
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Condiciones</a>
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="../ModuloCondiciones/condicionesMAERSK.php">Historial Condiciones MAERSK</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="../ModuloCondiciones/condicionesOTROS.php">Historial Condicion EXA y Otros</a>
                </div>
            </li>
            <li class="nav-item">
