...
$query .= "SELECT `id`, `num_contenedor`, `chasis`, `placa_chasis`,DATE_FORMAT( `fecha_ingreso`,'%e/%M/%Y') as 'fecha_ingreso', `genset`, `tamano`, `ejes`, `observacion`, DATE_FORMAT(`hora_ingreso`,'%r') as 'hora_ingreso',`tipo_tamano` FROM `contenedores` WHERE `estado`='Activo' AND `cliente`!='MAERSK'";
...
if (isset($_POST["export"])) {
  ...
  $file_name = 'Inventario Otros.xlsx';
